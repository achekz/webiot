...
const MuiBackdrop: Components<Theme>['MuiBackdrop'] = {
  styleOverrides: {
    root: ({ theme }) => ({
      backgroundColor: varAlpha(createPaletteChannel(grey[900]), 0.8),
    }),
    invisible: {
...
const MuiOutlinedInput: Components<Theme>['MuiOutlinedInput'] = {
  styleOverrides: {
    notchedOutline: ({ theme }) => ({
      borderColor: varAlpha(createPaletteChannel(grey[500]), 0.2),
    }),
  },
};
...
const MuiPaper: Components<Theme>['MuiPaper'] = {
  ...
  styleOverrides: {
    ...
    outlined: ({ theme }) => ({
      borderColor: varAlpha(createPaletteChannel(grey[500]), 0.16),
    }),
  },
};
