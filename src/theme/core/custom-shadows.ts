...
function createCustomShadows(colorChannel: string): CustomShadows {
  return {
    ...
    /********/
    primary: createShadowColor(createPaletteChannel(primary.main)),
    secondary: createShadowColor(createPaletteChannel(secondary.main)),
    info: createShadowColor(createPaletteChannel(info.main)),
    success: createShadowColor(createPaletteChannel(success.main)),
    warning: createShadowColor(createPaletteChannel(warning.main)),
    error: createShadowColor(createPaletteChannel(error.main)),
  };
}

export const customShadows: Partial<Record<ThemeColorScheme, CustomShadows>> = {
  light: createCustomShadows(createPaletteChannel(grey[500])),
};
